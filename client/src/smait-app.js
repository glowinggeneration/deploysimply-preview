...
const VOICE_ITEMS = [
  { name:'Maya Chen', role:'Clear · Curious · Informed', tenure:'Approachable', image:'/manus-storage/01-expert-maya-chen_17639807.png', description:'Maya makes complicated things feel simple without making them feel small. She brings context, clarity and practical thinking to conversations, helping people understand what matters and what to do next.' },
  { name:'Sipho Dlamini', role:'Experienced · Composed · Pragmatic', tenure:'Credible', image:'/manus-storage/02-expert-sipho-dlamini_fd3c32d2.png', description:'Sipho has the calm of someone who has seen a few cycles before. He separates signal from noise, adds perspective and gives people the information they need to make a more considered decision.' },
  { name:'Anika Patel', role:'Thoughtful · Patient · Precise', tenure:'Reassuring', image:'/manus-storage/03-expert-anika-patel_73b99b41.png', description:'Anika believes good advice should leave people more capable than it found them. She explains the detail, asks the useful question and brings a steady human perspective to complex conversations.' },
  { name:'Daniel Brooks', role:'Seasoned · Direct · Analytical', tenure:'Grounded', image:'/manus-storage/04-expert-daniel-brooks_ae0be880.png', description:'Daniel brings experience without needing to announce it. He notices patterns, remembers what came before and turns complicated developments into clear observations people can actually use.' },
  { name:'Zanele Mokoena', role:'Sharp · Confident · Curious', tenure:'Contemporary', image:'/manus-storage/05-challenger-zanele-mokoena_7a2c53c6.png', description:'Zanele rarely accepts the first answer simply because everyone else has. She asks the question others skipped, tests the logic and brings a fresh perspective without turning every conversation into an argument.' },
  { name:'Arjun Mehta', role:'Analytical · Independent · Witty', tenure:'Questioning', image:'/manus-storage/06-challenger-arjun-mehta_cf5d42fe.png', description:'Arjun enjoys finding the assumption hiding underneath the obvious answer. He challenges ideas with logic, asks for evidence and pushes conversations toward stronger conclusions rather than louder opinions.' },
  { name:'Claire Bennett', role:'Direct · Perceptive · Balanced', tenure:'Confident', image:'/manus-storage/07-challenger-claire-bennett_526d3b1d.png', description:'Claire knows that agreement is not always the same as understanding. She introduces the uncomfortable question at the right moment and helps people examine an issue from another side.' },
  { name:'Kenji Sato', role:'Reserved · Intelligent · Sceptical', tenure:'Deliberate', image:'/manus-storage/08-challenger-kenji-sato_025cdd2b.png', description:'Kenji is quietly difficult to convince, and that is the point. He looks for what has been overlooked, tests whether an argument holds up and challenges people without needing to dominate them.' },
  { name:'Priya Nair', role:'Warm · Upbeat · Expressive', tenure:'Social', image:'/manus-storage/09-hype-person-priya-nair_c7ffc01b.png', description:'Priya brings the energy people usually find after the meeting gets interesting. She spots what is worth celebrating, makes useful ideas feel exciting and pulls other people naturally into the conversation.' },
  { name:'Marcus Reed', role:'Charismatic · Positive · Conversational', tenure:'Assured', image:'/manus-storage/10-hype-person-marcus-reed_d5afeb64.png', description:'Marcus knows how to turn good news into something people actually want to talk about. He brings optimism without exaggeration and gives momentum to ideas, achievements and moments worth noticing.' },
  { name:'Sophie Walker', role:'Playful · Energetic · Informal', tenure:'Expressive', image:'/manus-storage/11-hype-person-sophie-walker_e80eb564.png', description:'Sophie reacts the way the internet moves: quickly, visually and with personality. She picks up the interesting part of a story and gives people an easy reason to join the conversation.' },
  { name:'Hiro Tanaka', role:'Warm · Optimistic · Generous', tenure:'Personable', image:'/manus-storage/12-hype-person-hiro-tanaka_b18a7b79.png', description:'Hiro proves enthusiasm does not have an age limit. He celebrates progress, encourages people generously and brings the kind of positive perspective that makes a conversation feel lighter without losing substance.' },
];
